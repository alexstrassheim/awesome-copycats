...
--[[
     ...
     Multicolor2 Awesome WM theme 2.0 
...
local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/multicolor2"
theme.wallpaper                                 = theme.confdir .. "/wallpaper/pexels-photo.jpeg"
-- theme.font                                      = "xos4 Terminus 12"
theme.font                                      = "Monospace 12.5"
...
theme.fg_focus                                  = "#4cb7db"
theme.fg_urgent                                 = "#af1d18"
theme.fg_minimize                               = "#E86850"
theme.border_width                              = 2
theme.border_normal                             = "#1c2022"
-- theme.border_focus                              = "#606060"
theme.border_focus                              = "#4cb7db"
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%a %d ") .. markup("#535f7a", ">") .. markup("#de5e1e", " %H:%M "))
